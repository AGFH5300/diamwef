...
export const committees: Committee[] = [
  ...
  {
    id: 'cmt-8',
    name: 'Trade and Supply Chain Forum',
    abbreviation: 'TSC',
    category: 'Senior Category 6',
    categoryShort: 'Senior',
    overview: 'Explores resilient trade corridors, logistics disruptions, and strategic supply chain policy.',
    round1Info: 'Detailed agenda to be released by the secretariat.',
    round2Info: 'Debate format details will be published soon.',
  },
  {
    id: 'cmt-9',
    name: 'Public Finance and Taxation Board',
    abbreviation: 'PFT',
    category: 'Senior Category 7',
    categoryShort: 'Senior',
    overview: 'Focuses on fiscal policy design, efficient taxation, and growth-supporting government spending.',
    round1Info: 'Detailed agenda to be released by the secretariat.',
    round2Info: 'Debate format details will be published soon.',
  },
  {
    id: 'cmt-10',
    name: 'Future of Work and Human Capital Council',
    abbreviation: 'FWH',
    category: 'Junior Category 3',
    categoryShort: 'Junior',
    overview: 'Examines workforce readiness, re-skilling systems, and human capital development for emerging economies.',
    round1Info: 'Detailed agenda to be released by the secretariat.',
    round2Info: 'Debate format details will be published soon.',
  },
  {
    id: 'cmt-11',
    name: 'Global Development and Aid Council',
    abbreviation: 'GDA',
    category: 'Junior Category 4',
    categoryShort: 'Junior',
    overview: 'Discusses development financing, aid effectiveness, and sustainable growth pathways for emerging regions.',
    round1Info: 'Detailed agenda to be released by the secretariat.',
    round2Info: 'Debate format details will be published soon.',
  },
];
