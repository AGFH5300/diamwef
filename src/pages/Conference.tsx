  ...
  return (
    <Layout>
      <PageHeader
        ...
        subtitle="Understand the format, rounds, and evaluation criteria for MWEF."
      />
              ...
              >
                <div className="bg-primary/5 border-b border-border p-6 flex items-center gap-4">
                  <div className="w-14 h-14 rounded-lg bg-accent/10 flex items-center justify-center">
                    <round.icon className="text-accent" size={28} />
                  </div>
                  <div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <motion.div
                ...
                style={{ boxShadow: 'var(--shadow-card)' }}
              >
                <Award className="text-accent mx-auto mb-3" size={36} />
