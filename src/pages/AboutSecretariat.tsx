...
import { leadershipTeam, coreTeam } from '@/data/team';

const AboutSecretariat = () => {
  return (
    <Layout>
      <PageHeader title="Secretariat Team" subtitle="Meet the leadership and core team behind the Model World Economic Forum." />
